...
import com.github.richardflee.astroimagej.action_handlers.ActionHandler;
...
//		}
	...
	private void setUpActionListeners() {
		...
		catalogQueryButton.addActionListener(e -> handler.doCatalogQuery());
		...
		// ======== dialogPane ========
		{
			...
			// ======== contentPanel ========
			{
									...
									.addGroup(panel5Layout.createParallelGroup()
											.addGroup(panel5Layout.createSequentialGroup()
													...
													.addGroup(panel5Layout
															...
															.addComponent(spinner1, GroupLayout.PREFERRED_SIZE, 60,
																	GroupLayout.PREFERRED_SIZE)
															.addComponent(spinner2, GroupLayout.PREFERRED_SIZE, 60,
																	GroupLayout.PREFERRED_SIZE)
															.addComponent(spinner3, GroupLayout.PREFERRED_SIZE, 60,
																	GroupLayout.PREFERRED_SIZE))
													.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
													.addGroup(panel5Layout.createParallelGroup().addComponent(label15)
															.addComponent(label16).addComponent(lowerMagLabel))
													.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
											.addGroup(panel5Layout.createSequentialGroup().addComponent(magCheckBox)
													.addGap(0, 0, Short.MAX_VALUE)))));
					panel5Layout.linkSize(SwingConstants.HORIZONTAL, new Component[] { spinner1, spinner2, spinner3 });
					panel5Layout.setVerticalGroup(panel5Layout.createParallelGroup().addGroup(panel5Layout
							.createSequentialGroup().addContainerGap()
							.addGroup(panel5Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
									.addComponent(label6)
									.addComponent(spinner1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
											GroupLayout.PREFERRED_SIZE)
									.addComponent(label15))
							.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
							.addGroup(panel5Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
									.addComponent(label14)
									.addComponent(spinner3, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
											GroupLayout.PREFERRED_SIZE)
									.addComponent(label16))
							.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
							.addGroup(panel5Layout.createParallelGroup().addComponent(label13)
									.addGroup(panel5Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
											.addComponent(spinner2, GroupLayout.PREFERRED_SIZE,
													GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
											.addComponent(lowerMagLabel)))
							.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(magCheckBox)
							.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
				}
				...
				// ======== panel6 ========
				{
					...
					panel6Layout.setHorizontalGroup(panel6Layout.createParallelGroup()
							.addGroup(panel6Layout.createSequentialGroup()
									.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
									.addGroup(panel6Layout.createParallelGroup().addComponent(magRadioButton)
											.addComponent(radialRadioButton))));
					panel6Layout.setVerticalGroup(panel6Layout.createParallelGroup().addGroup(
							panel6Layout.createSequentialGroup().addGap(4, 4, 4).addComponent(radialRadioButton)
									.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
									.addComponent(magRadioButton).addContainerGap(75, Short.MAX_VALUE)));
				}
				...
				// ======== panel7 ========
				{
					...
					saveQueryButton.setToolTipText(
							"<html>\nRuns a search for ObjectID on the SIMBAD online database\n<p>If the search is successful:</p>\n<p>  - updates RA and Dec fields with SIMBAD coordinates</p>\n<p>  - updates SIMBAD Data and Filter Magnitudes fields</p>\n<p>Note: ObjectID value is unchanged</p>\n</html>");
					...
					panel7Layout.setHorizontalGroup(panel7Layout.createParallelGroup()
							.addGroup(panel7Layout.createSequentialGroup().addContainerGap()
									.addGroup(panel7Layout.createParallelGroup()
											.addComponent(closeButton, GroupLayout.PREFERRED_SIZE, 139,
													GroupLayout.PREFERRED_SIZE)
											.addComponent(simbadButton, GroupLayout.PREFERRED_SIZE, 139,
													GroupLayout.PREFERRED_SIZE)
											.addComponent(saveQueryButton).addComponent(catalogQueryButton)
											.addComponent(updateButton).addComponent(saveRaDecButton)
											.addComponent(importRaDecButton).addComponent(clearButton))
									.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
						...
						.addGroup(contentPanelLayout.createSequentialGroup()
								...
								.addGroup(contentPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
										...
										.addComponent(panel1, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(panel2,
										GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
				contentPanelLayout.setVerticalGroup(contentPanelLayout.createParallelGroup()
						.addGroup(contentPanelLayout.createSequentialGroup()
								.addGroup(contentPanelLayout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
										.addComponent(panel7, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
										...
										.addGroup(GroupLayout.Alignment.LEADING,
												contentPanelLayout.createSequentialGroup().addContainerGap()
														...
														.addGroup(contentPanelLayout.createParallelGroup()
																.addComponent(panel3, GroupLayout.PREFERRED_SIZE, 159,
																		GroupLayout.PREFERRED_SIZE)
																.addComponent(panel4, GroupLayout.PREFERRED_SIZE, 159,
																		GroupLayout.PREFERRED_SIZE))
														.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
														.addGroup(contentPanelLayout.createParallelGroup()
