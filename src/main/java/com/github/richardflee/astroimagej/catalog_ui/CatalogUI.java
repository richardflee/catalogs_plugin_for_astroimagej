...
//		updateCatalogUiQuery(query);

//		// configure initial catalog settings
//		settings = new CatalogSettings();
//		updateCatalogUiSortFilter(settings);
			...
			// ======== contentPanel ========
			{
				...
				// ======== panel2 ========
				{
					...
					panel2Layout.setHorizontalGroup(panel2Layout.createParallelGroup().addComponent(tableScrollPane,
							GroupLayout.DEFAULT_SIZE, 741, Short.MAX_VALUE));
										...
										.addGroup(contentPanelLayout.createSequentialGroup()
												...
												.addGroup(contentPanelLayout
														...
														.addComponent(panel6, GroupLayout.PREFERRED_SIZE, 159,
																GroupLayout.PREFERRED_SIZE))))
								.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(contentPanelLayout.createParallelGroup().addComponent(label19)
